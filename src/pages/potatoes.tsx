...
import { ScrollControls, Scroll, useScroll } from '../components/potatoes/ScrollControls';
  ...
  <>
    <Page centerContent={false} showNav={false}>
      <div className="canvas">
        <Canvas orthographic camera={{ near: -100, far: 100, zoom: 3 }} gl={{ antialias: true }}>
...
function Scene() {
  return (
    <ScrollControls damping={10} pages={4}>
      <Scroll html>
        <div style={{ padding: '2em', lineHeight: '1.1em' }}>
          <div
            style={{
              fontSize: '2.3em',
              fontWeight: 700,
